...
public class BusinessPanel extends JPanel {
	...
	public BusinessPanel(Vehicleblservice vehicleblservice) {
		...
		BItransportPanel bItransportPanel=new BItransportPanel();
		tabbedPane.addTab("装车单", null, bItransportPanel, "建立装车单");
		
		BusinessCollectionPanel businessCollectionPanel=new BusinessCollectionPanel();
		tabbedPane.addTab("收款单", null, businessCollectionPanel, "建立收款单");
		
		BusinessDeliveryPanel businessDeliveryPanel=new BusinessDeliveryPanel();
		tabbedPane.addTab("派送单", null, businessDeliveryPanel, "建立派送单");
