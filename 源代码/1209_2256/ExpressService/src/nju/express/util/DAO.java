...
public class DAO {
	 ...
	 * @return
	 */
	public static int insertGetGeneratedKeyBySql(Class cl, String sql, Object[] obs) {
		int id = 0;
		Connection conn = ConnectionFactory.getInstance().makeConnection();
		PreparedStatement ps = null;
		ResultSet rs = null;

		// String sql = "insert into post ( barcode , sender_id_fk ,
		// receiver_id_fk , goods_id_fk ,collection_id_fk , post_type ,
		// packingexpense , post_estimateddatetime) "
		// + " values (?,?,?,?,?,?,?,?) ";
	...
	public static boolean updateBySql(Class cl, String sql, Object[] obs) {
		boolean b = false;
		Connection conn = ConnectionFactory.getInstance().makeConnection();
		PreparedStatement ps = null;
		// String sql = "update post set barcode = ? , sender_id_fk = ? ,
		// receiver_id_fk = ? , goods_id_fk = ? ,collection_id_fk = ? ,
		// post_type = ? , packingexpense = ? , post_estimateddatetime = ? "
		// + "where id = ? ";
