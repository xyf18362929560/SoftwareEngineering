...
public class BaseDataServiceImpl {
	...
	public  ArrayList getListByCondition(Class cl, String columnname, Object value) {
		ArrayList ar = new ArrayList();
		Connection conn = ConnectionFactory.getInstance().makeConnection();
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public  ArrayList getListByLike(Class cl, String columnname, Object value) {
		ArrayList ar = new ArrayList();
		Connection conn = ConnectionFactory.getInstance().makeConnection();
		PreparedStatement ps = null;
		ResultSet rs = null;
	 ...
	 * @return
	 */
	public  ArrayList<String> getAllColumnsByRSM(String tablename) {
	 ...
	 * @return
	 */
	public ArrayList<String> getAllColumnsByDBM(String tablename) {
		ArrayList<String> ar = new ArrayList<String>();
		Connection conn = ConnectionFactory.getInstance().makeConnection();
		ResultSet rs = null;
		try {
