...
import nju.express.dataservice.impl.MyOrderDataServiceImpl;
...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			MyOrderDataService orderDataService=new MyOrderDataServiceImpl();
			...
			Naming.rebind("rmi://127.0.0.1:6600/orderDataService", orderDataService);
